...
```json
{
  ...
  "evidence": [
    ...
    {"claim": "Implied price-to-sales at IPO", "value": "~93x sales at $1.75T valuation", "source": "S-1 valuation vs annualized Q1 revenue", "strength": "medium"},
...
一句话：生意极强、想象空间极大，但 IPO 给到约 93x 销售额、且上市后数月有大量内部人解禁排队，**现价是“好公司、坏买点”的典型形态——观察名单，等估值与供给消化，而非现在追。**
...
## 投资逻辑
SpaceX 是稀缺的“同时握住运力与天基连接两层”的资产：可复用火箭把发射成本压到难以复制的水平（强），Starlink 在此之上把这种运力变现成全球宽带订阅（强）。多头逻辑＝Starlink 现金牛持续扩张 + Starship 打开下一段更大的运力 TAM。**问题不在生意，在价格**：IPO 估值约 93x 销售额（示意性结论），把未来很多年的成功提前 price-in，安全边际极薄。
...
- 口径提示（示意）：两段营收（$3.257B + $619M = $3.876B）与合并 Q1’26 营收 $4.694B 的差额、以及两段经营盈亏（+$1.188B − $0.662B = +$0.526B）与合并经营亏损 −$1.943B 的差额，其余为公司层/抵消项（unallocated/corporate/eliminations，示意），不应逐项硬对平。
...
## 估值与买点
- 估值：约 93x 当期销售额（$1.75T 估值 ÷ 年化约 $18.8B 营收，中等证据，由 S-1 数据推算）。即便对超高增长龙头，这也处于历史与同业极端区间——valuation_growth_match=1。
...
### 下行情景
- 逻辑：若 Starship 商业化延后、连接段增速放缓，市场对 93x 销售额的容忍度会迅速收缩；叠加解禁抛压，估值可能向“可比高增长龙头上沿”均值回归。
- 估值地板（示意）：把销售倍数从约 93x 压到更“正常”的高增长区间，价格存在数量级的下修空间——这是“坏买点”风险的量化直觉，非精确目标价。
...
- 估值约 $1.75T、约 93x 销售额 — 由 S-1 估值与年化营收推算 — **中**
